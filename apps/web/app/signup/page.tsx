    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-5">
          ...
          {error && (
            <div
              className="text-xs sm:text-sm rounded-lg px-4 py-3"
              style={{
          ...
          <div className="relative my-6">
            <div
              ...
              style={{ borderTop: `1px solid ${theme.borders.medium}` }}
            >
              <div className="w-full text-center">
                <span
                  className="px-2 text-xs"
                  style={{ backgroundColor: theme.backgrounds.secondary, color: theme.text.muted }}
                >
                  Or continue with
                </span>
              </div>
          ...
          <button
            ...
            className="w-full py-2 px-4 text-sm font-medium rounded-lg hover:opacity-90 flex items-center justify-center gap-2"
            style={{
              backgroundColor: theme.backgrounds.tertiary,
              border: `1px solid ${theme.borders.medium}`,
              color: theme.text.primary,
