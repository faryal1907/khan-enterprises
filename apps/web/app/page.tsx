          ...
          >
            ...
            >
              <div className="flex justify-center gap-4 mb-3">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" style={{ color: theme.accents.primary }}>
                ...
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: theme.accents.primary }}>
            ...
            >
              <div className="flex justify-center mb-3">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" style={{ color: theme.accents.tertiary }}>
